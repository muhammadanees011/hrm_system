...
@section('action-button')
    @can('Create Event')
        <a href="#" data-url="{{ route('trainingevent.create') }}" data-ajax-popup="true" data-size="lg"
            data-title="{{ __('Create Trainging Event') }}" data-bs-toggle="tooltip" title="{{ __('Create') }}"
...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="mb-4">{{ __('Upcoming Training Events') }}</h4>
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col ml-n2">
                                                            <h5 class="text-sm mb-0 fc-event-title-container">
                                                                <a href="#" data-size="lg"
                                                                    data-url="{{ route('trainingevent.edit', $event->id) }}"
...
@push('script-page')
    ...
    <script type="text/javascript">
        ...
        function get_data() {
            ...
            $.ajax({
                url: $("#path_admin").val() + "/trainingevent/get_event_data",
                method: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
    ...
    <script>
        ...
        function getDepartment(bid) {
            ...
            $.ajax({
                url: '{{ route('trainingevent.getdepartment') }}',
                type: 'POST',
                data: {
                    "branch_id": bid,
                    "_token": "{{ csrf_token() }}",
        ...
        function getEmployee(did) {
            $.ajax({
                url: '{{ route('trainingevent.getemployee') }}',
                type: 'POST',
                data: {
                    "department_id": did,
                    "_token": "{{ csrf_token() }}",

...
@if (Auth::user()->type == 'company')
    {{ Form::model($event, ['route' => ['trainingevent.update', $event->id], 'method' => 'PUT']) }}
    <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="form-group">
                {{ Form::label('participants_limit', __('Participants Limit'), ['class' => 'col-form-label']) }}
                {{ Form::number('participants_limit', null, ['class' => 'form-control ', 'placeholder' => __('Enter Participants Limit')]) }}
            </div>
            <div class="form-group">
                            ...
                            <div class="">
                                <div class="card-body">
                                    <dl class="row">
                                        ...
                                        {{ Form::open(['url' => 'trainingeventrequest/store', 'method' => 'post']) }}
                                        {{ Form::hidden('training_event_id', $event->id) }}
                                        <div class="modal-footer">
                                            <input type="submit" value="{{ __('Request Participation') }}" class="btn btn-warning">
                                        </div>
                                        {{ Form::close() }}
                                    </dl>
                                </div>

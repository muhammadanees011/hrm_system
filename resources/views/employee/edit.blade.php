                                ...
                                <div class="float-right col-8">
                                    ...
                                    <div class="choose-files ">
                                        <label for="document[{{ $document->id }}]">
                                            ...
                                            <input type="file" class="form-control file  d-none @error('document') is-invalid @enderror" @if ($document->is_required == 1) @endif
                                        ...
                                        <img id="{{ 'blah' . $key }}" src="{{ isset($employeedoc[$document->id]) && !empty($employeedoc[$document->id]) ? $logo . '/' . $employeedoc[$document->id] : asset(Storage::url("uploads/avatar/defualt.png")) }}" width="50%" />

                                    </div>

                                    @if (!empty($employeedoc[$document->id]))
                                    <span class="text-xs"><a href="{{ !empty($employeedoc[$document->id]) ? $logo . '/' . $employeedoc[$document->id] : '' }}" target="_blank">

...
@section('page-title')
{{ __('Edit Pension Opt-out') }}
@endsection

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
<li class="breadcrumb-item"><a href="{{ url('pension-optout') }}">{{ __('Pension Opt-outs') }}</a></li>
<li class="breadcrumb-item">{{ __('Edit Pension Opt-out') }}</li>
@endsection
...
<div class="">
    <div class="">
        {{ Form::model($PensionOptout, ['route' => ['pension-optout.update', $PensionOptout->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
            <div class="col-md-6">

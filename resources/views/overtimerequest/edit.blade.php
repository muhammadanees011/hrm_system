    ...
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            <select name="status" class="form-control  select2" id="status">
                <option value="Pending"  @if($overtimerequest->status=='Pending') selected @endif>{{ __('Pending') }}</option>
                <option value="Approved" @if($overtimerequest->status=='Approved') selected @endif>{{ __('Approved') }}</option>
                <option value="Rejected" @if($overtimerequest->status=='Rejected') selected @endif>{{ __('Rejected') }}</option>
            </select>
        </div>
    </div>
</div>

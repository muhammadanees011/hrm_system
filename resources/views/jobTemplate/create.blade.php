...
<li class="breadcrumb-item"><a href="{{ route('job.index') }}">{{ __('Manage Job Template') }}</a></li>
<li class="breadcrumb-item">{{ __('Create Job Template') }}</li>
@endsection
...
{{ Form::open(['url' => 'job-template', 'method' => 'post']) }}
<div class="row mt-3">
    <div class="col-md-12">
            ...
            <div class="card-body ">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('job_template', old('job_template'), [
                        'class' => 'form-control',
                        'required' => 'required',
...
<script>
    ...
    myDropzone = new Dropzone("#my-dropzone", {
        ...
        url: "{{ route('job-template.files.upload') }}",

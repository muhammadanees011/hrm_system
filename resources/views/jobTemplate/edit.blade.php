...
{{Form::model($job,array('route' => array('job-template.update', $jobTemplate->id), 'method' => 'PUT')) }}
<div class="row mt-3">
    <div class="col-md-12">
            ...
            <div class="card-body ">
                <div class="row">
                    <div class="form-group col-md-12">
                        {!! Form::label('job_template', __('Job Template Title'), ['class' => 'col-form-label']) !!}
                        {!! Form::text('job_template', $jobTemplate->title, [
                        'class' => 'form-control',
                        'required' => 'required',
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="contract_type" id="contract_type" class="form-control select2" required>
                            ...
                            <option value="Apprenticeship" {{ ($job->contract_type == 'Apprenticeship') ? 'selected' : '' }}>Apprenticeship</option>
                            <option value="Zero Hours" {{ ($job->contract_type == 'Zero Hours') ? 'selected' : '' }}>Zero Hours</option>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            ...
                                                            <p class="card-text small text-muted">
                                                                {{ number_format(\File::size(storage_path('job_template_attachment/' . $file->files)) / 1048576, 2) . ' ' . _('MB') }}
                                                            </p>
                                                        </div>
                                                        @php
                                                            $attachments = \App\Models\Utility::get_file('job_template_attachment');
                                                        @endphp
                                                        ...
                                                        <div class="col-auto actions">
                                                            @can('Delete Attachment')
                                                                    <div class="action-btn bg-danger ms-2">
                                                                        <form action=""></form>
                                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['job-template.files.delete', $file->id, 1]]) !!}
                                                                        <a href="#!"

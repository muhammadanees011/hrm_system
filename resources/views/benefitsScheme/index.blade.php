                        ...
                        <tr>
                            ...
                            <td class="Action">
                                <span>
                                    ...
                                    <!--  URL::to('benefits-schemes/' . $scheme->id . '/edit') -->
                                        <a href="#" class="mx-3 btn btn-sm  align-items-center" data-url="" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="" data-title="{{ __('Edit Scheme') }}" data-bs-original-title="{{ __('Edit') }}">

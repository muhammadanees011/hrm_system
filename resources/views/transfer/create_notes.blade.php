...
{{ Form::open(['url' => 'store_notes/transfer', 'method' => 'post']) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-12">
            ...
            {{ Form::textarea('description', $transfer->description, ['class' => 'form-control', 'placeholder' => __('Enter Notes'),'rows'=>'3' , 'required' => 'required']) }}
        </div>
    </div>
</div>

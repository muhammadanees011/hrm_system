...
@section('page-title')
{{ __('Edit Benefits Opt-in') }}
@endsection

@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Home') }}</a></li>
<li class="breadcrumb-item"><a href="{{ url('benefits-opt-ins') }}">{{ __('Benefits Opt-ins') }}</a></li>
<li class="breadcrumb-item">{{ __('Edit Benefits Opt-ins') }}</li>
@endsection
...
<div class="">
    <div class="">
        {{ Form::model($PensionOptIn, ['route' => ['benefits-opt-ins.update', $PensionOptIn->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="card-body employee-detail-create-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-icon-user">
                                    {{ Form::select('benefits_scheme_id', $benefitsSchemes, null, ['class' => 'form-control benefits_scheme_id', 'required' => 'required', 'placeholder' => 'Select Benefits Scheme', 'id' => 'benefits_scheme_id']) }}
                                </div>
                            </div>
                            <div class="form-group">

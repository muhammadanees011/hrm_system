...
<a href="{{ route('benefits-opt-ins.create') }}" data-title="{{ __('Create Opt-in') }}" data-bs-toggle="tooltip" title="" class="btn btn-sm btn-primary" data-bs-original-title="{{ __('Create') }}">

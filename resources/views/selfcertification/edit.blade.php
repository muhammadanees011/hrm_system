...
{{ Form::model($selfcertification, ['route' => ['selfcertification.update', $selfcertification->id], 'method' => 'PUT']) }}
<div class="modal-body">

    @if ($chatgpt == 'on')
    <div class="text-end">
        <a href="#" class="btn btn-sm btn-primary" data-size="medium" data-ajax-popup-over="true"
            data-url="{{ route('generate', ['selfcertification']) }}" data-bs-toggle="tooltip" data-bs-placement="top"
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::text('certification_type', null, array('class' => 'form-control current_date','required'=>'required')) }}
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('details', null, ['class' => 'form-control', 'placeholder' => __('Details'),'rows' => '3' ,'required' => 'required']) }}
            </div>
        </div>
    </div>
</div>

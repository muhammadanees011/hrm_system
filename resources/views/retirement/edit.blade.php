...
{{ Form::model($retirement, ['route' => ['retirement.update', $retirement->id], 'method' => 'PUT']) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group  col-lg-6 col-md-6">
            {{ Form::label('retirement_type', __('Retirement Type')), ['class' => 'col-form-label'] }}
            {{ Form::select('retirement_type', $retirementtypes, null, ['class' => 'form-control select2', 'required' => 'required']) }}
        </div>
        <div class="form-group  col-lg-6 col-md-6">
        ...
        <div class="form-group  col-lg-6 col-md-6">
            {{ Form::label('retirement_date', __('Retirement Date'), ['class' => 'col-form-label']) }}
            {{ Form::text('retirement_date', null, ['class' => 'form-control d_week', 'autocomplete' => 'off' ,'required' => 'required']) }}
        </div>
        <div class="form-group  col-lg-6 col-md-6">

...
{{ Form::open(['url' => 'store_notes/warning', 'method' => 'post' ,'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-12">
            ...
            {{ Form::textarea('description', $warning->description, ['class' => 'form-control', 'placeholder' => __('Enter Notes'),'rows'=>'3' , 'required' => 'required']) }}
        </div>
    </div>
</div>

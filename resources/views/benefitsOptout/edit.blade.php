...
<div class="">
    <div class="">
        {{ Form::model($PensionOptout, ['route' => ['benefits-optout.update', $PensionOptout->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
            <div class="col-md-6">

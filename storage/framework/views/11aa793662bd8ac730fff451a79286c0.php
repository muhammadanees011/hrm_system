...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Employement Checks')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Employement Checks')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('action-button'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Create Job Application')): ?>
        <a href="#" data-url="<?php echo e(route('employementcheck.create')); ?>" data-ajax-popup="true" data-size="lg"
            data-title="<?php echo e(__('Create New Employement Check')); ?>" data-bs-toggle="tooltip" title=""
                ...
                <div class="col">
                    <div class="row mb-2">
                        <div class="col-xl-11 col-lg-11 col-md-11 col-sm-12 col-12">
                            <div class="btn-box">
                                <?php echo e(Form::label('employee', __('Search'), ['class' => 'form-label'])); ?>

                                <?php echo e(Form::text('employee', null, ['class' => 'form-control ', 'placeholder' => 'Search...'])); ?>
    ...
    <div class="card  mt-0 pt-5">
        <div class="container-kanban">
            <div class="row pt- kanban-wrapper horizontal-scroll-cards" style=" height:90vh;">
                    <!-- Dynamic Column -->
                    <?php $__currentLoopData = $employementchecktypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employementchecktype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col">
                        <div class="">
                            ...
                            <div class="card-header ps-3">
                                ...
                                <div style="background-color:#F6F7F8; height:50px; border-radius:5px; display:flex; justify-content:center;align-items:center;">
                                    <h4 class="mb-0" ><?php echo e($employementchecktype->title); ?></h4>
                                </div>
                            </div>
                            <div class="employement-checks-list" style="border-left:0.1rem solid rgba(0, 0, 0, 0.1); height:85vh;">
                            <?php $__currentLoopData = $employementchecks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employementcheck): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($employementchecktype->title == $employementcheck->employementcheckType->title): ?>
                                <div class="checks-file">
                                    <span>
                                    <a class="file-name" href="<?php echo e(route('employementcheck.view.file', ['filename' => $employementcheck->files])); ?>" target="_blank">
                                        <img src="<?php echo e(asset( '/assets/images/pdf.svg' )); ?>" height="20" width="20" alt="pdf" class="pdf-icon">
                                        <?php echo e(Str::limit($employementcheck->files, 30)); ?>

                                    </a>
                                    </span>
                                    <span>
                                    <a href="<?php echo e(route('employementcheck.download.file', ['filename' => $employementcheck->files])); ?>" class="btn btn-md file-download"
                                    ...
                                    <a href="<?php echo e(route('employementcheck.delete', $employementcheck->id)); ?>" class="btn btn-md file-delete"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hr_system\resources\views/employementcheck/index.blade.php ENDPATH**/ ?>
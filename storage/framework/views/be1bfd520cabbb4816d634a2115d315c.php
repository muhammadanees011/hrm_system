...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Meet Team')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Meet Team')); ?></li>
<?php $__env->stopSection(); ?>
                        ...
                        <div class="col-xl-10">
                            <div class="row">
                                <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="btn-box">
                                        <?php echo e(Form::label('branch', __('Select Branches*'), ['class' => 'form-label'])); ?>
        ...
        <div class="col-xl-3">
            <div class="card  text-center">
                ...
                <div class="card-body">
                    ...
                    <div><small class=""><?php echo e($employee->email ?? ''); ?></small></div>
                    <div><small class=""><?php echo e(ucfirst($employee->department->name ?? "")); ?></small></div>
                    <small
                        class=""><?php echo e(ucfirst($employee->designation->name ?? '')); ?></small>

                    <div class="row mt-2">
                        <div class="col-12 col-sm-12">
                            <div class="d-grid">
                                <a class="btn btn-outline-primary mx-5"><?php echo e(\Auth::user()->employeeIdFormat($employee->employee_id)); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hr_system\resources\views/employee/meetTeam.blade.php ENDPATH**/ ?>
            ...
            <!-- <?php if(Gate::check('Manage Job') ||
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon">
                        ...
                        <li class="dash-item dash-hasmenu  <?php echo e(Request::segment(1) == 'job' || Request::segment(1) == 'job-application' ? 'dash-trigger active' : ''); ?> ">
                            ...
                            class="dash-mtext"><?php echo e(__('Manage Contracts')); ?></span><span class="dash-arrow"><i
                            data-feather="chevron-right"></i></span></a>
                            <ul class="dash-submenu">
                                ...
                                <li class="dash-item <?php echo e(request()->is('contract*') ? 'active' : ''); ?>">
                                    <a class="dash-link" href="<?php echo e(route('contract.index')); ?>"><?php echo e(__('Contracts')); ?></a>
                                </li>
                                <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Contract')): ?>
                                <li class="dash-item <?php echo e(request()->is('contract.dual') ? 'active' : ''); ?>">
                                    <a class="dash-link" href="<?php echo e(route('contract.dual')); ?>"><?php echo e(__('Dual Contracts')); ?></a>
                                </li>
                                <?php endif; ?>
                            </ul>
                        </li>
...
<?php /**PATH C:\xampp\htdocs\hr_system\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>